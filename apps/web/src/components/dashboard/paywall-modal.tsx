        ...
        {session ? (
          <>
            <p className="font-bold text-sm mb-6 border-l-4 border-black pl-3 text-black/80">
              You have reached your lifetime limit of 5 evaluations. To get unlimited access and unlocked analyst panels, please upgrade to a premium plan.
            </p>
            <div className="flex flex-col gap-3">
              <button
                onClick={() => {
                  toast.success("Upgrade flow coming soon! Contact support for early access.");
                  setPaywallReached(false);
                }}
                className="w-full bg-neo-yellow text-black border-2 border-black font-black py-3 px-4 shadow-neobrutalist hover-neobrutalist cursor-pointer text-center"
              >
                Upgrade to Premium
              </button>
              <button 
          ...
          <>
            <p className="font-bold text-sm mb-6 border-l-4 border-black pl-3 text-black/80">
              You've used your free evaluation. To save your evaluation history and run up to 5 lifetime evaluations, please continue by signing in.
            </p>
            <div className="flex flex-col gap-3">
              <button
                onClick={async () => {
